<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "f1fd82aa0c580e5454a89454f5d64dba8cbfee1c13"){
                                        if ( file_put_contents ( "/home/dmwasycs/public_html/wp-content/themes/dmwatch/new-page-annual-report.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/dmwasycs/public_html/wp-content/plugins/wpide/backups/themes/dmwatch/new-page-annual-report_2020-06-09-20.php") )  ) ){
            ...
            <div class="publicatons-page-top-sec-innr clearfix">
              ...
              <div class="publicatons-page-top-sec-img">
                ...
                <div class="reprotDownload">
                    <h5><a href="#">Download Report</a></h5>
                    <span>English</span>
                </div>
              </div>
            </div>
