<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "f1fd82aa0c580e5454a89454f5d64dbaf45369adc7"){
                                        if ( file_put_contents ( "/home/dmwasycs/public_html/wp-content/themes/dmwatch/page-practice-areas.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/dmwasycs/public_html/wp-content/plugins/wpide/backups/themes/dmwatch/page-practice-areas_2020-06-09-20.php") )  ) ){
            ...
            <li>
              <div class="dm-pa-service-innr">
                <div class="dm-pa-service-img">
                  <a href="#"><img src="<?php echo THEME_URI; ?>/assets/images/dm-pa-service-img-1.png"></a>
                </div>
              </div>
            </li>
            <li>
              <div class="dm-pa-service-innr">
                <div class="dm-pa-service-img">
                  <a href="#"><img src="<?php echo THEME_URI; ?>/assets/images/dm-pa-service-img-2.png"></a>
                </div>
              </div>
            </li>
            <li>
              <div class="dm-pa-service-innr">
                <div class="dm-pa-service-img">
                  <a href="#"><img src="<?php echo THEME_URI; ?>/assets/images/dm-pa-service-img-3.png"></a>
                </div>
              </div>
            </li>
            <li>
              <div class="dm-pa-service-innr">
                <div class="dm-pa-service-img">
                  <a href="#"><img src="<?php echo THEME_URI; ?>/assets/images/dm-pa-service-img-4.png"></a>
                </div>
              </div>
            </li>
            <li>
              <div class="dm-pa-service-innr">
                <div class="dm-pa-service-img">
                  <a href="#"><img src="<?php echo THEME_URI; ?>/assets/images/dm-pa-service-img-5.png"></a>
                </div>
              </div>
            </li>
            <li>
              <div class="dm-pa-service-innr">
                <div class="dm-pa-service-img">
                  <a href="#"><img src="<?php echo THEME_URI; ?>/assets/images/dm-pa-service-img-6.png"></a>
                </div>
              </div>
            </li>
            <li>
              <div class="dm-pa-service-innr">
                <div class="dm-pa-service-img">
                  <a href="#"><img src="<?php echo THEME_URI; ?>/assets/images/dm-pa-service-img-7.png"></a>
                </div>
              </div>
            </li>
          </ul>
