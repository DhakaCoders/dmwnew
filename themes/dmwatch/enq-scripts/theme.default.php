...
wp_enqueue_script('anime', 'https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js', array('jquery'), '1.0.0', true);
wp_enqueue_script('cbv-custom', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '1.0.0', true);
wp_enqueue_script('cbv-custom-ajax', get_template_directory_uri() . '/assets/js/loadmore-js.js', array('jquery'), '1.0.0', true);
